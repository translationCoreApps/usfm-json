...
exports.usfmToJSON = function (usfmInput) {
  ...
  if (chapters.length > 1) {
    ...
    usfmJSON.headers = getHeaders(usfm);
    return usfmJSON;
  } else {
    //verse snippet of usfm
...
function cleanUpVerseText(verseText) {
